...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/page/meetingResource.js"></script>
	</head>
	<body>
		<div class="query">
		...
		<div id="addWindow" class="easyui-window" title="流媒体信息" closed="true"
			...
			<div class="easyui-layout" fit="true">
				<div region="center" border="false"
					...
					<form action="<%=path%>/meetingResource_save.do" method="post"
						id="saveForm">
						<table width="100%" border="0" style="font-size: 13">
							<tr style="display: none;">
								...
								<td>
									<input type="text" name="meetingResource.id" id="id">
									<input type="text" name="meetingResource.comId" id="comId">
									<input type="text" name="meetingResource.zcode" id="zcode">
									<input type="text" name="meetingResource.status" id="status">
									<input type="text" name="meetingResource.usedAccount" id="usedAccount">
									<input type="text" name="meetingResource.usedTime" id="usedTime">
									<input type="text" name="meetingResource.addTime" id="addTime">
									<input type="text" name="meetingResource.isMeeting" id="isMeeting">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" name="meetingResource.account" id="account">
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<input type="password" name="meetingResource.password" id="password"
							...
							<tr>
								...
								<td>
									<input type="text" name="meetingResource.nickName" id="nickName">
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<input type="text" name="meetingResource.participants" id="participants"
										class="easyui-validatebox" required="true"
										validType="length[1,200]" invalidMessage="长度为200...">
								</td>
							</tr>
