...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/page/meetingRecord.js"></script>
	...
	<body>
		<div class="query">
			...
			<div id="showdiv" style="height: 20px;">
				<form method="post" id="queryForm" action="<%=path%>/meetingRecord_query.do" onkeydown="if(event.keyCode==13){return false;}">
					<table style="width: 100%; height: 100%" cellspacing=1
						...
						<tr>
							...
							<td bgcolor="#ffffff" align="center">
								用户账号：
								<input type="text" id="userAccount" style="width: 150px;">
							</td>
							<td bgcolor="#ffffff" align="center">
								用户名称：
		...
		<div id="meetingInfoWindow" class="easyui-window" title="会议详情" closed="true"
			collapsible="false" minimizable="false" maximizable="false" iconCls="icon-add"
			style="width: 700px; height: 450px; display: none;" resizable="false">
			<div class="easyui-layout" fit="true">
				<div region="center" border="false"
