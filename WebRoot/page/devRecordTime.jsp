...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/page/devRecordTime.js"></script>
	...
	<body>
		<div class="query">
			...
			<div id="showdiv" style="height: 20px;">
				<form method="post" id="queryForm" action="<%=path%>/devRecordTime_query.do" onkeydown="if(event.keyCode==13){return false;}">
					<table style="width: 100%; height: 100%" cellspacing=1
						...
						<tr>
							<td bgcolor="#ffffff" align="center">
								...
								<input type="text" name="groupName" id="groupName" readonly="readonly" onclick="createGroupTree();" style="width:120px;height:20px;margin-right:30px;cursor: pointer;">
							</td>
							<td bgcolor="#ffffff" align="center">
								设备名称：
								<input type="text" id="queryDevName" style="width: 150px;">
							</td>
							<td bgcolor="#ffffff" align="center">
								日期：
								<input type="text" readonly="readonly"  id="addTimeStart"  name="addTimeStart" onfocus="WdatePicker({startDate:'%y-%M-%d %H:%m:%s',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d',alwaysUseStartDate:true})" class="Wdate" style="width:120px;"/>
								至
								<input type="text" readonly="readonly"  id="addTimeEnd"  name="addTimeEnd" onfocus="WdatePicker({startDate:'%y-%M-%d %H:%m:%s',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d',alwaysUseStartDate:true})" class="Wdate" style="width:120px;"/>
							</td>
							<td bgcolor="#ffffff" align="center">
